...
<style>
	...
	.modal-backdrop[data-backdrop-color="white"] {
		background: rgba(255, 255, 255, 0.6);
	}

	.modal-backdrop[data-backdrop-blur="true"] {
	...
	.modal-backdrop[data-panel-color="transparent"] .modal-panel {
		background: transparent;
		box-shadow: none;
	}
	...
	.modal-body {
		...
		overflow: overlay;
		padding: 0 24px 24px;
		mask-image: linear-gradient(rgba(255, 255, 255, 1) calc(100% - 24px),
